...
describe Administrate::Field::String do
  ...
  describe "#to_partial_path" do
    it "returns a partial based on the page being rendered" do
      page = :show
      field = Administrate::Field::String.new(Class.new.new,:string, "hello", page)
  ...
  describe "#truncate" do
    it "renders an empty string for nil" do
      string = Administrate::Field::String.new(Class.new.new,:description, nil, :show)

      expect(string.truncate).to eq("")
    end

    it "defaults to displaying up to 50 characters" do
      short = Administrate::Field::String.new(Class.new.new,:title, lorem(30), :show)
      long = Administrate::Field::String.new(Class.new.new,:description, lorem(60), :show)
  ...
  def string_with_options(string, options)
    Administrate::Field::String.new(Class.new.new,:string, string, :page, options)
  end
