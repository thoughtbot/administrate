  ...
  var require_selectize_min = __commonJS({
    "node_modules/@selectize/selectize/dist/js/selectize.min.js"(exports, module) {
      (function(root, factory) {
        ...
        "use strict";
        var highlight = function(t2, e2) {
          var r2, a2;
          if ("string" != typeof e2 || e2.length) return r2 = "string" == typeof e2 ? new RegExp(e2, "i") : e2, a2 = function(t3) {
            var e3 = 0;
            if (3 === t3.nodeType) {
              var n2, i2, o2 = t3.data.search(r2);
              0 <= o2 && 0 < t3.data.length && (i2 = t3.data.match(r2), (n2 = document.createElement("span")).className = "highlight", (o2 = t3.splitText(o2)).splitText(i2[0].length), i2 = o2.cloneNode(true), n2.appendChild(i2), o2.parentNode.replaceChild(n2, o2), e3 = 1);
            } else if (1 === t3.nodeType && t3.childNodes && !/(script|style)/i.test(t3.tagName) && ("highlight" !== t3.className || "SPAN" !== t3.tagName)) for (var s2 = 0; s2 < t3.childNodes.length; ++s2) s2 += a2(t3.childNodes[s2]);
            return e3;
          }, t2.each(function() {
            a2(this);
          });
          ...
          return this.find("span.highlight").each(function() {
            ...
            t2.replaceChild(this.firstChild, this), t2.normalize();
          }).end();
        }, function() {
        }), MicroPlugin = (MicroEvent.prototype = { on: function(t2, e2) {
          this._events = this._events || {}, this._events[t2] = this._events[t2] || [], this._events[t2].push(e2);
        }, off: function(t2, e2) {
          var n2 = arguments.length;
          return 0 === n2 ? delete this._events : 1 === n2 ? delete this._events[t2] : (this._events = this._events || {}, void (t2 in this._events != false && this._events[t2].splice(this._events[t2].indexOf(e2), 1)));
        }, trigger: function(t2) {
          var e2 = this._events = this._events || {};
          if (t2 in e2 != false) for (var n2 = 0; n2 < e2[t2].length; n2++) e2[t2][n2].apply(this, Array.prototype.slice.call(arguments, 1));
        } }, MicroEvent.mixin = function(t2) {
          for (var e2 = ["on", "off", "trigger"], n2 = 0; n2 < e2.length; n2++) t2.prototype[e2[n2]] = MicroEvent.prototype[e2[n2]];
        }, {}), utils = (MicroPlugin.mixin = function(o2) {
          o2.plugins = {}, o2.prototype.initializePlugins = function(t2) {
            var e2, n2, i2, o3 = this, s2 = [];
            if (o3.plugins = { names: [], settings: {}, requested: {}, loaded: {} }, utils.isArray(t2)) for (e2 = 0, n2 = t2.length; e2 < n2; e2++) "string" == typeof t2[e2] ? s2.push(t2[e2]) : (o3.plugins.settings[t2[e2].name] = t2[e2].options, s2.push(t2[e2].name));
            else if (t2) for (i2 in t2) t2.hasOwnProperty(i2) && (o3.plugins.settings[i2] = t2[i2], s2.push(i2));
            for (; s2.length; ) o3.require(s2.shift());
          }, o2.prototype.loadPlugin = function(t2) {
            var e2 = this, n2 = e2.plugins, i2 = o2.plugins[t2];
            if (!o2.plugins.hasOwnProperty(t2)) throw new Error('Unable to find "' + t2 + '" plugin');
            n2.requested[t2] = true, n2.loaded[t2] = i2.fn.apply(e2, [e2.plugins.settings[t2] || {}]), n2.names.push(t2);
          }, o2.prototype.require = function(t2) {
            var e2 = this, n2 = e2.plugins;
            if (!e2.plugins.loaded.hasOwnProperty(t2)) {
              if (n2.requested[t2]) throw new Error('Plugin has circular dependency ("' + t2 + '")');
              e2.loadPlugin(t2);
            }
            return n2.loaded[t2];
          }, o2.define = function(t2, e2) {
            o2.plugins[t2] = { name: t2, fn: e2 };
          };
        }, { isArray: Array.isArray || function(t2) {
          return "[object Array]" === Object.prototype.toString.call(t2);
        } }), Sifter = function(t2, e2) {
          this.items = t2, this.settings = e2 || { diacritics: true };
        }, cmp = (Sifter.prototype.tokenize = function(t2, e2) {
          if (!(t2 = trim(String(t2 || "").toLowerCase())) || !t2.length) return [];
          for (var n2, i2, o2 = [], s2 = t2.split(/ +/), r2 = 0, a2 = s2.length; r2 < a2; r2++) {
          ...
          return o2;
        }, Sifter.prototype.iterator = function(t2, e2) {
          var n2 = is_array(t2) ? Array.prototype.forEach || function(t3) {
            for (var e3 = 0, n3 = this.length; e3 < n3; e3++) t3(this[e3], e3, this);
          } : function(t3) {
            for (var e3 in this) this.hasOwnProperty(e3) && t3(this[e3], e3, this);
          };
          n2.apply(t2, [e2]);
        }, Sifter.prototype.getScoreFunction = function(t2, e2) {
          function o2(t3, e3) {
            var n2;
            return !t3 || -1 === (n2 = (t3 = String(t3 || "")).search(e3.regex)) ? 0 : (e3 = e3.string.length / t3.length, 0 === n2 && (e3 += 0.5), e3);
          }
          var s2, r2 = (t2 = this.prepareSearch(t2, e2)).tokens, a2 = t2.options.fields, l2 = r2.length, p2 = t2.options.nesting, c2 = (s2 = a2.length) ? 1 === s2 ? function(t3, e3) {
            return o2(getattr(e3, a2[0], p2), t3);
          } : function(t3, e3) {
            for (var n2 = 0, i2 = 0; n2 < s2; n2++) i2 += o2(getattr(e3, a2[n2], p2), t3);
            return i2 / s2;
          } : function() {
            return 0;
          };
          return l2 ? 1 === l2 ? function(t3) {
            return c2(r2[0], t3);
          } : "and" === t2.options.conjunction ? function(t3) {
            for (var e3, n2 = 0, i2 = 0; n2 < l2; n2++) {
              if ((e3 = c2(r2[n2], t3)) <= 0) return 0;
              i2 += e3;
            }
            return i2 / l2;
          } : function(t3) {
            for (var e3 = 0, n2 = 0; e3 < l2; e3++) n2 += c2(r2[e3], t3);
            return n2 / l2;
          } : function() {
            return 0;
          };
        }, Sifter.prototype.getSortFunction = function(t2, n2) {
          var e2, i2, o2, s2, r2, a2, l2, p2 = this, c2 = !(t2 = p2.prepareSearch(t2, n2)).query && n2.sort_empty || n2.sort, u2 = function(t3, e3) {
            return "$score" === t3 ? e3.score : getattr(p2.items[e3.id], t3, n2.nesting);
          }, d2 = [];
          if (c2) for (e2 = 0, i2 = c2.length; e2 < i2; e2++) !t2.query && "$score" === c2[e2].field || d2.push(c2[e2]);
          if (t2.query) {
          ...
          return (s2 = d2.length) ? 1 === s2 ? (o2 = d2[0].field, r2 = a2[0], function(t3, e3) {
            return r2 * cmp(u2(o2, t3), u2(o2, e3));
          }) : function(t3, e3) {
            for (var n3, i3 = 0; i3 < s2; i3++) if (n3 = d2[i3].field, n3 = a2[i3] * cmp(u2(n3, t3), u2(n3, e3))) return n3;
            return 0;
          } : null;
        }, Sifter.prototype.prepareSearch = function(t2, e2) {
          var n2, i2, o2;
          return "object" == typeof t2 ? t2 : (n2 = (e2 = extend3({}, e2)).fields, i2 = e2.sort, o2 = e2.sort_empty, n2 && !is_array(n2) && (e2.fields = [n2]), i2 && !is_array(i2) && (e2.sort = [i2]), o2 && !is_array(o2) && (e2.sort_empty = [o2]), { options: e2, query: String(t2 || "").toLowerCase(), tokens: this.tokenize(t2, e2.respect_word_boundaries), total: 0, items: [] });
        }, Sifter.prototype.search = function(t2, n2) {
          var i2, o2, e2 = this, s2 = this.prepareSearch(t2, n2);
          return n2 = s2.options, t2 = s2.query, o2 = n2.score || e2.getScoreFunction(s2), t2.length ? e2.iterator(e2.items, function(t3, e3) {
            i2 = o2(t3), (false === n2.filter || 0 < i2) && s2.items.push({ score: i2, id: e3 });
          }) : e2.iterator(e2.items, function(t3, e3) {
            s2.items.push({ score: 1, id: e3 });
          }), (t2 = e2.getSortFunction(s2, n2)) && s2.items.sort(t2), s2.total = s2.items.length, "number" == typeof n2.limit && (s2.items = s2.items.slice(0, n2.limit)), s2;
        }, function(t2, e2) {
          return "number" == typeof t2 && "number" == typeof e2 ? e2 < t2 ? 1 : t2 < e2 ? -1 : 0 : (t2 = asciifold(String(t2 || "")), (e2 = asciifold(String(e2 || ""))) < t2 ? 1 : t2 < e2 ? -1 : 0);
        }), extend3 = function(t2, e2) {
          for (var n2, i2, o2 = 1, s2 = arguments.length; o2 < s2; o2++) if (i2 = arguments[o2]) for (n2 in i2) i2.hasOwnProperty(n2) && (t2[n2] = i2[n2]);
          return t2;
        }, getattr = function(t2, e2, n2) {
          if (t2 && e2) {
            if (!n2) return t2[e2];
            for (var i2 = e2.split("."); i2.length && (t2 = t2[i2.shift()]); ) ;
            return t2;
          }
        }, trim = function(t2) {
          return (t2 + "").replace(/^\s+|\s+$|/g, "");
        }, escape_regex = function(t2) {
          return (t2 + "").replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1");
        }, is_array = Array.isArray || "undefined" != typeof $4 && $4.isArray || function(t2) {
          return "[object Array]" === Object.prototype.toString.call(t2);
          ...
          var t2, e2, n2, i2, o2 = "", s2 = {};
          for (n2 in DIACRITICS) if (DIACRITICS.hasOwnProperty(n2)) for (o2 += i2 = DIACRITICS[n2].substring(2, DIACRITICS[n2].length - 1), t2 = 0, e2 = i2.length; t2 < e2; t2++) s2[i2.charAt(t2)] = n2;
          var r2 = new RegExp("[" + o2 + "]", "g");
          return function(t3) {
            return t3.replace(r2, function(t4) {
              return s2[t4];
            }).toLowerCase();
          };
        }();
        function uaDetect(t2, e2) {
          return navigator.userAgentData ? t2 === navigator.userAgentData.platform : e2.test(navigator.userAgent);
        }
        var IS_MAC = uaDetect("macOS", /Mac/), KEY_A = 65, KEY_COMMA = 188, KEY_RETURN = 13, KEY_ESC = 27, KEY_LEFT = 37, KEY_UP = 38, KEY_P = 80, KEY_RIGHT = 39, KEY_DOWN = 40, KEY_N = 78, KEY_BACKSPACE = 8, KEY_DELETE = 46, KEY_SHIFT = 16, KEY_CMD = IS_MAC ? 91 : 17, KEY_CTRL = IS_MAC ? 18 : 17, KEY_TAB = 9, TAG_SELECT = 1, TAG_INPUT = 2, SUPPORTS_VALIDITY_API = !uaDetect("Android", /android/i) && !!document.createElement("input").validity, isset = function(t2) {
          return void 0 !== t2;
        }, hash_key = function(t2) {
          return null == t2 ? null : "boolean" == typeof t2 ? t2 ? "1" : "0" : t2 + "";
        }, escape_html = function(t2) {
          return (t2 + "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;");
        }, escape_replace = function(t2) {
          return (t2 + "").replace(/\$/g, "$$$$");
        }, hook = { before: function(t2, e2, n2) {
          var i2 = t2[e2];
          t2[e2] = function() {
            return n2.apply(t2, arguments), i2.apply(t2, arguments);
          };
        }, after: function(e2, t2, n2) {
          var i2 = e2[t2];
          e2[t2] = function() {
            var t3 = i2.apply(e2, arguments);
            return n2.apply(e2, arguments), t3;
          };
        } }, once = function(t2) {
          var e2 = false;
          return function() {
        ...
        }, debounce_events = function(e2, n2, t2) {
          var i2, o2 = e2.trigger, s2 = {};
          for (i2 in e2.trigger = function() {
            var t3 = arguments[0];
            if (-1 === n2.indexOf(t3)) return o2.apply(e2, arguments);
            s2[t3] = arguments;
          }, t2.apply(e2, []), e2.trigger = o2, s2) s2.hasOwnProperty(i2) && o2.apply(e2, s2[i2]);
        }, watchChildEvent = function(n2, t2, e2, i2) {
          n2.on(t2, e2, function(t3) {
            for (var e3 = t3.target; e3 && e3.parentNode !== n2[0]; ) e3 = e3.parentNode;
            return t3.currentTarget = e3, i2.apply(this, [t3]);
          });
        }, getInputSelection = function(t2) {
          var e2, n2, i2 = {};
          return void 0 === t2 ? console.warn("WARN getInputSelection cannot locate input control") : "selectionStart" in t2 ? (i2.start = t2.selectionStart, i2.length = t2.selectionEnd - i2.start) : document.selection && (t2.focus(), e2 = document.selection.createRange(), n2 = document.selection.createRange().text.length, e2.moveStart("character", -t2.value.length), i2.start = e2.text.length - n2, i2.length = n2), i2;
        }, transferStyles = function(t2, e2, n2) {
          var i2, o2, s2 = {};
          if (n2) for (i2 = 0, o2 = n2.length; i2 < o2; i2++) s2[n2[i2]] = t2.css(n2[i2]);
          else s2 = t2.css();
          e2.css(s2);
        }, measureString = function(t2, e2) {
          return t2 ? (Selectize.$testInput || (Selectize.$testInput = $4("<span />").css({ position: "absolute", width: "auto", padding: 0, whiteSpace: "pre" }), $4("<div />").css({ position: "absolute", width: 0, height: 0, overflow: "hidden" }).append(Selectize.$testInput).appendTo("body")), Selectize.$testInput.text(t2), transferStyles(e2, Selectize.$testInput, ["letterSpacing", "fontSize", "fontFamily", "fontWeight", "textTransform"]), Selectize.$testInput.width()) : 0;
        }, autoGrow = function(s2) {
          function t2(t3, e2) {
            var n2, i2, o2;
            e2 = e2 || {}, (t3 = t3 || window.event || {}).metaKey || t3.altKey || !e2.force && false === s2.data("grow") || (e2 = s2.val(), t3.type && "keydown" === t3.type.toLowerCase() && (n2 = 48 <= (i2 = t3.keyCode) && i2 <= 57 || 65 <= i2 && i2 <= 90 || 96 <= i2 && i2 <= 111 || 186 <= i2 && i2 <= 222 || 32 === i2, i2 === KEY_DELETE || i2 === KEY_BACKSPACE ? (o2 = getInputSelection(s2[0])).length ? e2 = e2.substring(0, o2.start) + e2.substring(o2.start + o2.length) : i2 === KEY_BACKSPACE && o2.start ? e2 = e2.substring(0, o2.start - 1) + e2.substring(o2.start + 1) : i2 === KEY_DELETE && void 0 !== o2.start && (e2 = e2.substring(0, o2.start) + e2.substring(o2.start + 1)) : n2 && (i2 = t3.shiftKey, o2 = String.fromCharCode(t3.keyCode), e2 += o2 = i2 ? o2.toUpperCase() : o2.toLowerCase())), t3 = (n2 = s2.attr("placeholder")) ? measureString(n2, s2) + 4 : 0, (i2 = Math.max(measureString(e2, s2), t3) + 4) === r2) || (r2 = i2, s2.width(i2), s2.triggerHandler("resize"));
          }
          var r2 = null;
          s2.on("keydown keyup update blur", t2), t2();
        }, domToString = function(t2) {
          var e2 = document.createElement("div");
          return e2.appendChild(t2.cloneNode(true)), e2.innerHTML;
        }, logError = function(t2, e2) {
          e2 = e2 || {};
          console.error("Selectize: " + t2), e2.explanation && (console.group && console.group(), console.error(e2.explanation), console.group) && console.groupEnd();
        }, isJSON = function(t2) {
          try {
            JSON.parse(str);
          } catch (t3) {
          ...
          return true;
        }, Selectize = function(t2, e2) {
          var n2, i2, o2 = this, s2 = t2[0], r2 = (s2.selectize = o2, window.getComputedStyle && window.getComputedStyle(s2, null));
          if (r2 = (r2 ? r2.getPropertyValue("direction") : s2.currentStyle && s2.currentStyle.direction) || t2.parents("[dir]:first").attr("dir") || "", $4.extend(o2, { order: 0, settings: e2, $input: t2, tabIndex: t2.attr("tabindex") || "", tagType: "select" === s2.tagName.toLowerCase() ? TAG_SELECT : TAG_INPUT, rtl: /rtl/i.test(r2), eventNS: ".selectize" + ++Selectize.count, highlightedValue: null, isBlurring: false, isOpen: false, isDisabled: false, isRequired: t2.is("[required]"), isInvalid: false, isLocked: false, isFocused: false, isInputHidden: false, isSetup: false, isShiftDown: false, isCmdDown: false, isCtrlDown: false, ignoreFocus: false, ignoreBlur: false, ignoreHover: false, hasOptions: false, currentResults: null, lastValue: "", lastValidValue: "", lastOpenTarget: false, caretPos: 0, loading: 0, loadedSearches: {}, isDropdownClosing: false, $activeOption: null, $activeItems: [], optgroups: {}, options: {}, userOptions: {}, items: [], renderCache: {}, onSearchChange: null === e2.loadThrottle ? o2.onSearchChange : debounce2(o2.onSearchChange, e2.loadThrottle) }), o2.sifter = new Sifter(this.options, { diacritics: e2.diacritics }), o2.settings.options) {
        ...
        MicroEvent.mixin(Selectize), MicroPlugin.mixin(Selectize), $4.extend(Selectize.prototype, { setup: function() {
          var e2 = this, t2 = e2.settings, n2 = e2.eventNS, i2 = $4(window), o2 = $4(document), s2 = e2.$input, r2 = e2.settings.mode, a2 = s2.attr("class") || "", l2 = $4("<div>").addClass(t2.wrapperClass).addClass(a2 + " selectize-control").addClass(r2), p2 = $4("<div>").addClass(t2.inputClass + " selectize-input items").appendTo(l2), c2 = $4('<input type="select-one" autocomplete="new-password" autofill="no" />').appendTo(p2).attr("tabindex", s2.is(":disabled") ? "-1" : e2.tabIndex), u2 = $4(t2.dropdownParent || l2), r2 = $4("<div>").addClass(t2.dropdownClass).addClass(r2 + " selectize-dropdown").hide().appendTo(u2), u2 = $4("<div>").addClass(t2.dropdownContentClass + " selectize-dropdown-content").attr("tabindex", "-1").appendTo(r2), d2 = ((d2 = s2.attr("id")) && (c2.attr("id", d2 + "-selectized"), $4("label[for='" + d2 + "']").attr("for", d2 + "-selectized")), e2.settings.copyClassesToDropdown && r2.addClass(a2), l2.css({ width: s2[0].style.width }), e2.plugins.names.length && (d2 = "plugin-" + e2.plugins.names.join(" plugin-"), l2.addClass(d2), r2.addClass(d2)), (null === t2.maxItems || 1 < t2.maxItems) && e2.tagType === TAG_SELECT && s2.attr("multiple", "multiple"), e2.settings.placeholder && c2.attr("placeholder", t2.placeholder), e2.settings.search || (c2.attr("readonly", true), c2.attr("inputmode", "none"), p2.css("cursor", "pointer")), !e2.settings.splitOn && e2.settings.delimiter && (a2 = e2.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"), e2.settings.splitOn = new RegExp("\\s*" + a2 + "+\\s*")), s2.attr("autocorrect") && c2.attr("autocorrect", s2.attr("autocorrect")), s2.attr("autocapitalize") && c2.attr("autocapitalize", s2.attr("autocapitalize")), s2.is("input") && (c2[0].type = s2[0].type), e2.$wrapper = l2, e2.$control = p2, e2.$control_input = c2, e2.$dropdown = r2, e2.$dropdown_content = u2, r2.on("mouseenter mousedown mouseup click", "[data-disabled]>[data-selectable]", function(t3) {
          ...
          } }), c2.on({ mousedown: function(t3) {
            "" === e2.$control_input.val() && !e2.settings.openOnFocus || t3.stopPropagation();
          }, keydown: function() {
          ...
          } }), o2.on("keydown" + n2, function(t3) {
            e2.isCmdDown = t3[IS_MAC ? "metaKey" : "ctrlKey"], e2.isCtrlDown = t3[IS_MAC ? "altKey" : "ctrlKey"], e2.isShiftDown = t3.shiftKey;
          }), o2.on("keyup" + n2, function(t3) {
            t3.keyCode === KEY_CTRL && (e2.isCtrlDown = false), t3.keyCode === KEY_SHIFT && (e2.isShiftDown = false), t3.keyCode === KEY_CMD && (e2.isCmdDown = false);
          }), o2.on("mousedown" + n2, function(t3) {
            if (e2.isFocused) {
              if (t3.target === e2.$dropdown[0] || t3.target.parentNode === e2.$dropdown[0]) return false;
              e2.$dropdown.has(t3.target).length || t3.target === e2.$control[0] || e2.blur(t3.target);
            }
          ...
          s2.replaceWith(d2), d2.replaceWith(s2), this.revertSettings = { $children: a2, tabindex: s2.attr("tabindex") }, s2.attr("tabindex", -1).hide().after(e2.$wrapper), Array.isArray(t2.items) && (e2.lastValidValue = t2.items, e2.setValue(t2.items), delete t2.items), SUPPORTS_VALIDITY_API && s2.on("invalid" + n2, function(t3) {
            t3.preventDefault(), e2.isInvalid = true, e2.refreshState();
          }), e2.updateOriginalInput(), e2.refreshItems(), e2.refreshState(), e2.updatePlaceholder(), e2.isSetup = true, s2.is(":disabled") && e2.disable(), e2.on("change", this.onChange), s2.data("selectize", e2), s2.addClass("selectized"), e2.trigger("initialize"), true === t2.preload && e2.onSearchChange("");
        }, setupTemplates: function() {
          var t2 = this, i2 = t2.settings.labelField, o2 = t2.settings.valueField, n2 = t2.settings.optgroupLabelField;
          t2.settings.render = $4.extend({}, { optgroup: function(t3) {
            return '<div class="optgroup">' + t3.html + "</div>";
          }, optgroup_header: function(t3, e2) {
            return '<div class="optgroup-header">' + e2(t3[n2]) + "</div>";
          }, option: function(t3, e2) {
            var n3 = t3.classes ? " " + t3.classes : "";
            return n3 += "" === t3[o2] ? " selectize-dropdown-emptyoptionlabel" : "", "<div" + (t3.styles ? ' style="' + t3.styles + '"' : "") + ' class="option' + n3 + '">' + e2(t3[i2]) + "</div>";
          }, item: function(t3, e2) {
            return '<div class="item">' + e2(t3[i2]) + "</div>";
          }, option_create: function(t3, e2) {
            return '<div class="create">Add <strong>' + e2(t3.input) + "</strong>&#x2026;</div>";
          } }, t2.settings.render);
        }, setupCallbacks: function() {
          var t2, e2, n2 = { initialize: "onInitialize", change: "onChange", item_add: "onItemAdd", item_remove: "onItemRemove", clear: "onClear", option_add: "onOptionAdd", option_remove: "onOptionRemove", option_clear: "onOptionClear", optgroup_add: "onOptionGroupAdd", optgroup_remove: "onOptionGroupRemove", optgroup_clear: "onOptionGroupClear", dropdown_open: "onDropdownOpen", dropdown_close: "onDropdownClose", type: "onType", load: "onLoad", focus: "onFocus", blur: "onBlur", dropdown_item_activate: "onDropdownItemActivate", dropdown_item_deactivate: "onDropdownItemDeactivate" };
          for (t2 in n2) n2.hasOwnProperty(t2) && (e2 = this.settings[n2[t2]]) && this.on(t2, e2);
        }, onClick: function(t2) {
          this.isDropdownClosing || this.isFocused && this.isOpen || (this.focus(), t2.preventDefault());
        }, onMouseDown: function(t2) {
          var e2 = this, n2 = t2.isDefaultPrevented();
          $4(t2.target);
          if (e2.isFocused || n2 || window.setTimeout(function() {
            e2.focus();
          }, 0), t2.target !== e2.$control_input[0] || "" === e2.$control_input.val()) return "single" === e2.settings.mode ? e2.isOpen ? e2.close() : e2.open() : (n2 || e2.setActiveItem(null), e2.settings.openOnFocus || (e2.isOpen && t2.target === e2.lastOpenTarget ? (e2.close(), e2.lastOpenTarget = false) : (e2.isOpen || (e2.refreshOptions(), e2.open()), e2.lastOpenTarget = t2.target))), false;
        }, onChange: function() {
          "" !== this.getValue() && (this.lastValidValue = this.getValue()), this.$input.trigger("input"), this.$input.trigger("change");
        }, onPaste: function(t2) {
          var o2 = this;
          o2.isFull() || o2.isInputHidden || o2.isLocked ? t2.preventDefault() : o2.settings.splitOn && setTimeout(function() {
            var t3 = o2.$control_input.val();
            if (t3.match(o2.settings.splitOn)) for (var e2 = t3.trim().split(o2.settings.splitOn), n2 = 0, i2 = e2.length; n2 < i2; n2++) o2.createItem(e2[n2]);
          }, 0);
        }, onKeyPress: function(t2) {
          var e2;
          return this.isLocked ? t2 && t2.preventDefault() : (e2 = String.fromCharCode(t2.keyCode || t2.which), this.settings.create && "multi" === this.settings.mode && e2 === this.settings.delimiter ? (this.createItem(), t2.preventDefault(), false) : void 0);
        }, onKeyDown: function(t2) {
          t2.target, this.$control_input[0];
          var e2, n2 = this;
          if (n2.isLocked) t2.keyCode !== KEY_TAB && t2.preventDefault();
          else {
            switch (t2.keyCode) {
              case KEY_A:
                ...
                break;
              case KEY_ESC:
                return void (n2.isOpen && (t2.preventDefault(), t2.stopPropagation(), n2.close()));
              case KEY_N:
                if (!t2.ctrlKey || t2.altKey) break;
              case KEY_DOWN:
                return !n2.isOpen && n2.hasOptions ? n2.open() : n2.$activeOption && (n2.ignoreHover = true, (e2 = n2.getAdjacentOption(n2.$activeOption, 1)).length) && n2.setActiveOption(e2, true, true), void t2.preventDefault();
              case KEY_P:
                if (!t2.ctrlKey || t2.altKey) break;
              case KEY_UP:
                return n2.$activeOption && (n2.ignoreHover = true, (e2 = n2.getAdjacentOption(n2.$activeOption, -1)).length) && n2.setActiveOption(e2, true, true), void t2.preventDefault();
              case KEY_RETURN:
                return void (n2.isOpen && n2.$activeOption && (n2.onOptionSelect({ currentTarget: n2.$activeOption }), t2.preventDefault()));
              case KEY_LEFT:
                return void n2.advanceSelection(-1, t2);
              case KEY_RIGHT:
                return void n2.advanceSelection(1, t2);
              case KEY_TAB:
                return n2.settings.selectOnTab && n2.isOpen && n2.$activeOption && (n2.onOptionSelect({ currentTarget: n2.$activeOption }), n2.isFull() || t2.preventDefault()), void (n2.settings.create && n2.createItem() && n2.settings.showAddOptionOnCreate && t2.preventDefault());
              case KEY_BACKSPACE:
              case KEY_DELETE:
                return void n2.deleteSelection(t2);
            }
            !n2.isFull() && !n2.isInputHidden || (IS_MAC ? t2.metaKey : t2.ctrlKey) || t2.preventDefault();
          }
        }, onInput: function(t2) {
          ...
          i2 && !n2.loadedSearches.hasOwnProperty(e2) && (n2.loadedSearches[e2] = true, n2.load(function(t2) {
            i2.apply(n2, [e2, t2]);
          }));
        }, onFocus: function(t2) {
          var e2 = this, n2 = e2.isFocused;
          if (e2.isDisabled) return e2.blur(), t2 && t2.preventDefault(), false;
        ...
        }, onOptionHover: function(t2) {
          this.ignoreHover || this.setActiveOption(t2.currentTarget, false);
        }, onOptionSelect: function(t2) {
          var e2, n2 = this;
          t2.preventDefault && (t2.preventDefault(), t2.stopPropagation()), (e2 = $4(t2.currentTarget)).hasClass("create") ? n2.createItem(null, function() {
            n2.settings.closeAfterSelect && n2.close();
          }) : void 0 !== (e2 = e2.attr("data-value")) && (n2.lastQuery = null, n2.setTextboxValue(""), n2.addItem(e2), n2.settings.closeAfterSelect ? n2.close() : !n2.settings.hideSelected && t2.type && /mouse/.test(t2.type) && n2.setActiveOption(n2.getOption(e2)));
        }, onItemSelect: function(t2) {
          this.isLocked || "multi" === this.settings.mode && (t2.preventDefault(), this.setActiveItem(t2.currentTarget, t2));
        }, load: function(t2) {
          var e2 = this, n2 = e2.$wrapper.addClass(e2.settings.loadingClass);
          e2.loading++, t2.apply(e2, [function(t3) {
            e2.loading = Math.max(e2.loading - 1, 0), t3 && t3.length && (e2.addOption(t3), e2.refreshOptions(e2.isFocused && !e2.isInputHidden)), e2.loading || n2.removeClass(e2.settings.loadingClass), e2.trigger("load", t3);
          }]);
        }, getTextboxValue: function() {
          return this.$control_input.val();
        }, setTextboxValue: function(t2) {
          var e2 = this.$control_input;
          e2.val() !== t2 && (e2.val(t2).triggerHandler("update"), this.lastValue = t2);
        }, getValue: function() {
          ...
          (Array.isArray(t2) ? t2 : [t2]).join("") !== this.items.join("") && debounce_events(this, e2 ? [] : ["change"], function() {
            this.clear(e2), this.addItems(t2, e2);
          });
        }, setMaxItems: function(t2) {
          this.settings.maxItems = t2 = 0 === t2 ? null : t2, this.settings.mode = this.settings.mode || (1 === this.settings.maxItems ? "single" : "multi"), this.refreshState();
        }, setActiveItem: function(t2, e2) {
          var n2, i2, o2, s2, r2, a2, l2 = this;
          if ("single" !== l2.settings.mode) if ((t2 = $4(t2)).length) {
            if ("mousedown" === (n2 = e2 && e2.type.toLowerCase()) && l2.isShiftDown && l2.$activeItems.length) {
              for (a2 = l2.$control.children(".active:last"), a2 = Array.prototype.indexOf.apply(l2.$control[0].childNodes, [a2[0]]), (o2 = Array.prototype.indexOf.apply(l2.$control[0].childNodes, [t2[0]])) < a2 && (r2 = a2, a2 = o2, o2 = r2), i2 = a2; i2 <= o2; i2++) s2 = l2.$control[0].childNodes[i2], -1 === l2.$activeItems.indexOf(s2) && ($4(s2).addClass("active"), l2.$activeItems.push(s2));
              e2.preventDefault();
            } else "mousedown" === n2 && l2.isCtrlDown || "keydown" === n2 && this.isShiftDown ? t2.hasClass("active") ? (r2 = l2.$activeItems.indexOf(t2[0]), l2.$activeItems.splice(r2, 1), t2.removeClass("active")) : l2.$activeItems.push(t2.addClass("active")[0]) : ($4(l2.$activeItems).removeClass("active"), l2.$activeItems = [t2.addClass("active")[0]]);
            l2.hideInput(), this.isFocused || l2.focus();
          } else $4(l2.$activeItems).removeClass("active"), l2.$activeItems = [], l2.isFocused && l2.showInput();
        }, setActiveOption: function(t2, e2, n2) {
          var i2, o2, s2, r2, a2 = this;
          a2.$activeOption && (a2.$activeOption.removeClass("active"), a2.trigger("dropdown_item_deactivate", a2.$activeOption.attr("data-value"))), a2.$activeOption = null, (t2 = $4(t2)).length && (a2.$activeOption = t2.addClass("active"), a2.isOpen && a2.trigger("dropdown_item_activate", a2.$activeOption.attr("data-value")), !e2 && isset(e2) || (t2 = a2.$dropdown_content.height(), i2 = a2.$activeOption.outerHeight(true), e2 = a2.$dropdown_content.scrollTop() || 0, r2 = (s2 = o2 = a2.$activeOption.offset().top - a2.$dropdown_content.offset().top + e2) - t2 + i2, t2 + e2 < o2 + i2 ? a2.$dropdown_content.stop().animate({ scrollTop: r2 }, n2 ? a2.settings.scrollDuration : 0) : o2 < e2 && a2.$dropdown_content.stop().animate({ scrollTop: s2 }, n2 ? a2.settings.scrollDuration : 0)));
        }, selectAll: function() {
          var t2 = this;
          "single" !== t2.settings.mode && (t2.$activeItems = Array.prototype.slice.apply(t2.$control.children(":not(input)").addClass("active")), t2.$activeItems.length && (t2.hideInput(), t2.close()), t2.focus());
        }, hideInput: function() {
          ...
          var t2 = this;
          return t2.isDisabled || (t2.ignoreFocus = true, t2.$control_input[0].focus(), window.setTimeout(function() {
            t2.ignoreFocus = false, t2.onFocus();
          }, 0)), t2;
        }, blur: function(t2) {
          return this.$control_input[0].blur(), this.onBlur(null, t2), this;
        }, getScoreFunction: function(t2) {
          return this.sifter.getScoreFunction(t2, this.getSearchOptions());
        }, getSearchOptions: function() {
          var t2 = this.settings, e2 = t2.sortField;
          return { fields: t2.searchField, conjunction: t2.searchConjunction, sort: e2 = "string" == typeof e2 ? [{ field: e2 }] : e2, nesting: t2.nesting, filter: t2.filter, respect_word_boundaries: t2.respect_word_boundaries };
        }, search: function(t2) {
          var e2, n2, i2, o2 = this, s2 = o2.settings, r2 = this.getSearchOptions();
          if (s2.score && "function" != typeof (i2 = o2.settings.score.apply(this, [t2]))) throw new Error('Selectize "score" setting must be a function that returns a function');
          if (t2 !== o2.lastQuery ? (s2.normalize && (t2 = t2.normalize("NFD").replace(/[\u0300-\u036f]/g, "")), o2.lastQuery = t2, n2 = o2.sifter.search(t2, $4.extend(r2, { score: i2 })), o2.currentResults = n2) : n2 = $4.extend(true, {}, o2.currentResults), s2.hideSelected) for (e2 = n2.items.length - 1; 0 <= e2; e2--) -1 !== o2.items.indexOf(hash_key(n2.items[e2].id)) && n2.items.splice(e2, 1);
          return n2;
        }, refreshOptions: function(t2) {
          void 0 === t2 && (t2 = true);
          ...
          for (this.settings.lockOptgroupOrder && s2.sort(function(t3, e3) {
            return (g2.optgroups[t3] && g2.optgroups[t3].$order || 0) - (g2.optgroups[e3] && g2.optgroups[e3].$order || 0);
          ...
          "auto" !== g2.settings.dropdownSize.sizeType && g2.isOpen && g2.setupDropdownHeight(), (u2 = g2.canCreate(f2)) && g2.settings.showAddOptionOnCreate && (m2.prepend(g2.render("option_create", { input: f2 })), h2 = $4(m2[0].childNodes[0])), g2.hasOptions = 0 < v2.items.length || u2 && g2.settings.showAddOptionOnCreate || g2.settings.setFirstOptionActive, g2.hasOptions ? (0 < v2.items.length ? (f2 = y2 && g2.getOption(y2), "" !== v2.query && g2.settings.setFirstOptionActive ? d2 = m2.find("[data-selectable]:first") : "" !== v2.query && f2 && f2.length ? d2 = f2 : "single" === g2.settings.mode && g2.items.length && (d2 = g2.getOption(g2.items[0])), d2 && d2.length || (d2 = h2 && !g2.settings.addPrecedence ? g2.getAdjacentOption(h2, 1) : m2.find("[data-selectable]:first"))) : d2 = h2, g2.setActiveOption(d2), t2 && !g2.isOpen && g2.open()) : (g2.setActiveOption(null), t2 && g2.isOpen && g2.close());
        }, addOption: function(t2) {
          var e2, n2, i2, o2 = this;
          if (Array.isArray(t2)) for (e2 = 0, n2 = t2.length; e2 < n2; e2++) o2.addOption(t2[e2]);
          else (i2 = o2.registerOption(t2)) && (o2.userOptions[i2] = true, o2.lastQuery = null, o2.trigger("option_add", i2, t2));
        }, registerOption: function(t2) {
          var e2 = hash_key(t2[this.settings.valueField]);
          return null != e2 && !this.options.hasOwnProperty(e2) && (t2.$order = t2.$order || ++this.order, this.options[e2] = t2, e2);
        }, registerOptionGroup: function(t2) {
          var e2 = hash_key(t2[this.settings.optgroupValueField]);
          return !!e2 && (t2.$order = t2.$order || ++this.order, this.optgroups[e2] = t2, e2);
        }, addOptionGroup: function(t2, e2) {
          e2[this.settings.optgroupValueField] = t2, (t2 = this.registerOptionGroup(e2)) && this.trigger("optgroup_add", t2, e2);
        }, removeOptionGroup: function(t2) {
          this.optgroups.hasOwnProperty(t2) && (delete this.optgroups[t2], this.renderCache = {}, this.trigger("optgroup_remove", t2));
        }, clearOptionGroups: function() {
          this.optgroups = {}, this.renderCache = {}, this.trigger("optgroup_clear");
        }, updateOption: function(t2, e2) {
          var n2, i2, o2, s2 = this;
          if (t2 = hash_key(t2), n2 = hash_key(e2[s2.settings.valueField]), null !== t2 && s2.options.hasOwnProperty(t2)) {
            if ("string" != typeof n2) throw new Error("Value must be set in option data");
            o2 = s2.options[t2].$order, n2 !== t2 && (delete s2.options[t2], -1 !== (i2 = s2.items.indexOf(t2))) && s2.items.splice(i2, 1, n2), e2.$order = e2.$order || o2, s2.options[n2] = e2, i2 = s2.renderCache.item, o2 = s2.renderCache.option, i2 && (delete i2[t2], delete i2[n2]), o2 && (delete o2[t2], delete o2[n2]), -1 !== s2.items.indexOf(n2) && (i2 = s2.getItem(t2), o2 = $4(s2.render("item", e2)), i2.hasClass("active") && o2.addClass("active"), i2.replaceWith(o2)), s2.lastQuery = null, s2.isOpen && s2.refreshOptions(false);
          }
        }, removeOption: function(t2, e2) {
          var n2 = this, i2 = (t2 = hash_key(t2), n2.renderCache.item), o2 = n2.renderCache.option;
          i2 && delete i2[t2], o2 && delete o2[t2], delete n2.userOptions[t2], delete n2.options[t2], n2.lastQuery = null, n2.trigger("option_remove", t2), n2.removeItem(t2, e2);
        }, clearOptions: function(t2) {
          var n2 = this, i2 = (n2.loadedSearches = {}, n2.userOptions = {}, n2.renderCache = {}, n2.options);
          $4.each(n2.options, function(t3, e2) {
            -1 == n2.items.indexOf(t3) && delete i2[t3];
          }), n2.options = n2.sifter.items = i2, n2.lastQuery = null, n2.trigger("option_clear"), n2.clear(t2);
        }, getOption: function(t2) {
          return this.getElementWithValue(t2, this.$dropdown_content.find("[data-selectable]"));
        }, getFirstOption: function() {
          var t2 = this.$dropdown.find("[data-selectable]");
          return 0 < t2.length ? t2.eq(0) : $4();
        }, getAdjacentOption: function(t2, e2) {
          var n2 = this.$dropdown.find("[data-selectable]"), t2 = n2.index(t2) + e2;
          return 0 <= t2 && t2 < n2.length ? n2.eq(t2) : $4();
        }, getElementWithValue: function(t2, e2) {
          if (null != (t2 = hash_key(t2))) {
            for (var n2 = 0, i2 = e2.length; n2 < i2; n2++) if (e2[n2].getAttribute("data-value") === t2) return $4(e2[n2]);
          }
          return $4();
        }, getElementWithTextContent: function(t2, e2, n2) {
          if (null != (t2 = hash_key(t2))) for (var i2 = 0, o2 = n2.length; i2 < o2; i2++) {
            var s2 = n2[i2].textContent;
            if (1 == e2 && (s2 = null !== s2 ? s2.toLowerCase() : null, t2 = t2.toLowerCase()), s2 === t2) return $4(n2[i2]);
          }
          return $4();
        }, getItem: function(t2) {
          return this.getElementWithValue(t2, this.$control.children());
        }, getFirstItemMatchedByTextContent: function(t2, e2) {
          return this.getElementWithTextContent(t2, e2 = null !== e2 && true === e2, this.$dropdown_content.find("[data-selectable]"));
        }, addItems: function(t2, e2) {
          this.buffer = document.createDocumentFragment();
          for (var n2 = this.$control[0].childNodes, i2 = 0; i2 < n2.length; i2++) this.buffer.appendChild(n2[i2]);
          for (var o2 = Array.isArray(t2) ? t2 : [t2], i2 = 0, s2 = o2.length; i2 < s2; i2++) this.isPending = i2 < s2 - 1, this.addItem(o2[i2], e2);
          t2 = this.$control[0];
          t2.insertBefore(this.buffer, t2.firstChild), this.buffer = null;
        }, addItem: function(s2, r2) {
          debounce_events(this, r2 ? [] : ["change"], function() {
            var t2, e2, n2, i2 = this, o2 = i2.settings.mode;
            s2 = hash_key(s2), -1 !== i2.items.indexOf(s2) ? "single" === o2 && i2.close() : i2.options.hasOwnProperty(s2) && ("single" === o2 && i2.clear(r2), "multi" === o2 && i2.isFull() || (t2 = $4(i2.render("item", i2.options[s2])), n2 = i2.isFull(), i2.items.splice(i2.caretPos, 0, s2), i2.insertAtCaret(t2), i2.isPending && (n2 || !i2.isFull()) || i2.refreshState(), i2.isSetup && (n2 = i2.$dropdown_content.find("[data-selectable]"), i2.isPending || (e2 = i2.getOption(s2), e2 = i2.getAdjacentOption(e2, 1).attr("data-value"), i2.refreshOptions(i2.isFocused && "single" !== o2), e2 && i2.setActiveOption(i2.getOption(e2))), !n2.length || i2.isFull() ? i2.close() : i2.isPending || i2.positionDropdown(), i2.updatePlaceholder(), i2.trigger("item_add", s2, t2), i2.isPending || i2.updateOriginalInput({ silent: r2 }))));
          });
        }, removeItem: function(t2, e2) {
          var n2, i2, o2 = this, s2 = t2 instanceof $4 ? t2 : o2.getItem(t2);
          t2 = hash_key(s2.attr("data-value")), -1 !== (n2 = o2.items.indexOf(t2)) && (o2.trigger("item_before_remove", t2, s2), s2.remove(), s2.hasClass("active") && (s2.removeClass("active"), i2 = o2.$activeItems.indexOf(s2[0]), o2.$activeItems.splice(i2, 1), s2.removeClass("active")), o2.items.splice(n2, 1), o2.lastQuery = null, !o2.settings.persist && o2.userOptions.hasOwnProperty(t2) && o2.removeOption(t2, e2), n2 < o2.caretPos && o2.setCaret(o2.caretPos - 1), o2.refreshState(), o2.updatePlaceholder(), o2.updateOriginalInput({ silent: e2 }), o2.positionDropdown(), o2.trigger("item_remove", t2, s2));
        }, createItem: function(t2, n2) {
          var i2 = this, o2 = i2.caretPos, s2 = (t2 = t2 || (i2.$control_input.val() || "").trim(), arguments[arguments.length - 1]);
          if ("function" != typeof s2 && (s2 = function() {
          }), "boolean" != typeof n2 && (n2 = true), !i2.canCreate(t2)) return s2(), false;
          i2.lock();
          var e2 = "function" == typeof i2.settings.create ? this.settings.create : function(t3) {
            var e3 = {}, t3 = e3[i2.settings.labelField] = t3;
            if (!i2.settings.formatValueToKey || "function" != typeof i2.settings.formatValueToKey || null != (t3 = i2.settings.formatValueToKey.apply(this, [t3])) && "object" != typeof t3 && "function" != typeof t3) return e3[i2.settings.valueField] = t3, e3;
            throw new Error('Selectize "formatValueToKey" setting must be a function that returns a value other than object or function.');
          }, r2 = once(function(t3) {
            var e3;
            return i2.unlock(), !t3 || "object" != typeof t3 || "string" != typeof (e3 = hash_key(t3[i2.settings.valueField])) ? s2() : (i2.setTextboxValue(""), i2.addOption(t3), i2.setCaret(o2), i2.addItem(e3), i2.refreshOptions(n2 && "single" !== i2.settings.mode), void s2(t3));
          }), e2 = e2.apply(this, [t2, r2]);
          return void 0 !== e2 && r2(e2), true;
        }, refreshItems: function(t2) {
          this.lastQuery = null, this.isSetup && this.addItem(this.items, t2), this.refreshState(), this.updateOriginalInput({ silent: t2 });
        }, refreshState: function() {
          this.refreshValidityState(), this.refreshClasses();
        }, refreshValidityState: function() {
          if (!this.isRequired) return false;
          var t2 = !this.items.length;
          this.isInvalid = t2, this.$control_input.prop("required", t2), this.$input.prop("required", !t2);
        }, refreshClasses: function() {
          var t2 = this, e2 = t2.isFull(), n2 = t2.isLocked;
          t2.$wrapper.toggleClass("rtl", t2.rtl), t2.$control.toggleClass("focus", t2.isFocused).toggleClass("disabled", t2.isDisabled).toggleClass("required", t2.isRequired).toggleClass("invalid", t2.isInvalid).toggleClass("locked", n2).toggleClass("full", e2).toggleClass("not-full", !e2).toggleClass("input-active", t2.isFocused && !t2.isInputHidden).toggleClass("dropdown-active", t2.isOpen).toggleClass("has-options", !$4.isEmptyObject(t2.options)).toggleClass("has-items", 0 < t2.items.length), t2.$control_input.data("grow", !e2 && !n2);
        }, isFull: function() {
          return null !== this.settings.maxItems && this.items.length >= this.settings.maxItems;
        }, updateOriginalInput: function(t2) {
          var e2, n2, i2, o2, s2, r2, a2 = this;
          t2 = t2 || {}, a2.tagType === TAG_SELECT ? (o2 = a2.$input.find("option"), e2 = [], n2 = [], i2 = [], r2 = [], o2.get().forEach(function(t3) {
            e2.push(t3.value);
          }), a2.items.forEach(function(t3) {
            s2 = a2.options[t3][a2.settings.labelField] || "", r2.push(t3), -1 == e2.indexOf(t3) && n2.push('<option value="' + escape_html(t3) + '" selected="selected">' + escape_html(s2) + "</option>");
          }), i2 = e2.filter(function(t3) {
            return r2.indexOf(t3) < 0;
          }).map(function(t3) {
            return 'option[value="' + t3 + '"]';
          }), e2.length - i2.length + n2.length !== 0 || a2.$input.attr("multiple") || n2.push('<option value="" selected="selected"></option>'), a2.$input.find(i2.join(", ")).remove(), a2.$input.append(n2.join(""))) : (a2.$input.val(a2.getValue()), a2.$input.attr("value", a2.$input.val())), a2.isSetup && !t2.silent && a2.trigger("change", a2.$input.val());
        }, updatePlaceholder: function() {
          var t2;
          this.settings.placeholder && (t2 = this.$control_input, this.items.length ? t2.removeAttr("placeholder") : t2.attr("placeholder", this.settings.placeholder), t2.triggerHandler("update", { force: true }));
        }, open: function() {
          var t2 = this;
          t2.isLocked || t2.isOpen || "multi" === t2.settings.mode && t2.isFull() || (t2.focus(), t2.isOpen = true, t2.refreshState(), t2.$dropdown.css({ visibility: "hidden", display: "block" }), t2.setupDropdownHeight(), t2.positionDropdown(), t2.$dropdown.css({ visibility: "visible" }), t2.trigger("dropdown_open", t2.$dropdown));
        }, close: function() {
          var t2 = this, e2 = t2.isOpen;
          "single" === t2.settings.mode && t2.items.length && (t2.hideInput(), t2.isBlurring) && t2.$control_input[0].blur(), t2.isOpen = false, t2.$dropdown.hide(), t2.setActiveOption(null), t2.refreshState(), e2 && t2.trigger("dropdown_close", t2.$dropdown);
        }, positionDropdown: function() {
          var t2 = this.$control, e2 = "body" === this.settings.dropdownParent ? t2.offset() : t2.position(), t2 = (e2.top += t2.outerHeight(true), t2[0].getBoundingClientRect().width);
          this.settings.minWidth && this.settings.minWidth > t2 && (t2 = this.settings.minWidth), this.$dropdown.css({ width: t2, top: e2.top, left: e2.left });
        }, setupDropdownHeight: function() {
          if ("object" == typeof this.settings.dropdownSize && "auto" !== this.settings.dropdownSize.sizeType) {
            var t2 = this.settings.dropdownSize.sizeValue;
            if ("numberItems" === this.settings.dropdownSize.sizeType) {
              for (var e2 = this.$dropdown_content.find("*").not(".optgroup, .highlight").not(this.settings.ignoreOnDropwdownHeight), n2 = 0, i2 = 0, o2 = 0, s2 = 0, r2 = 0; r2 < t2; r2++) {
                var a2 = $4(e2[r2]);
                if (0 === a2.length) break;
                n2 += a2.outerHeight(true), void 0 === a2.data("selectable") && (a2.hasClass("optgroup-header") && (a2 = window.getComputedStyle(a2.parent()[0], ":before")) && (i2 = a2.marginTop ? Number(a2.marginTop.replace(/\W*(\w)\w*/g, "$1")) : 0, o2 = a2.marginBottom ? Number(a2.marginBottom.replace(/\W*(\w)\w*/g, "$1")) : 0, s2 = a2.borderTopWidth ? Number(a2.borderTopWidth.replace(/\W*(\w)\w*/g, "$1")) : 0), t2++);
              }
              t2 = n2 + (this.$dropdown_content.css("padding-top") ? Number(this.$dropdown_content.css("padding-top").replace(/\W*(\w)\w*/g, "$1")) : 0) + (this.$dropdown_content.css("padding-bottom") ? Number(this.$dropdown_content.css("padding-bottom").replace(/\W*(\w)\w*/g, "$1")) : 0) + i2 + o2 + s2 + "px";
            ...
            this.$dropdown_content.css({ height: t2, maxHeight: "none" });
          }
        }, clear: function(t2) {
          var e2 = this;
          e2.items.length && (e2.$control.children(":not(input)").remove(), e2.items = [], e2.lastQuery = null, e2.setCaret(0), e2.setActiveItem(null), e2.updatePlaceholder(), e2.updateOriginalInput({ silent: t2 }), e2.refreshState(), e2.showInput(), e2.trigger("clear"));
        }, insertAtCaret: function(t2) {
          var e2 = Math.min(this.caretPos, this.items.length), t2 = t2[0], n2 = this.buffer || this.$control[0];
          0 === e2 ? n2.insertBefore(t2, n2.firstChild) : n2.insertBefore(t2, n2.childNodes[e2]), this.setCaret(e2 + 1);
        }, deleteSelection: function(t2) {
          var e2, n2, i2, o2, s2, r2 = this, a2 = t2 && t2.keyCode === KEY_BACKSPACE ? -1 : 1, l2 = getInputSelection(r2.$control_input[0]);
          if (r2.$activeOption && !r2.settings.hideSelected && (o2 = ("string" == typeof r2.settings.deselectBehavior && "top" === r2.settings.deselectBehavior ? r2.getFirstOption() : r2.getAdjacentOption(r2.$activeOption, -1)).attr("data-value")), i2 = [], r2.$activeItems.length) {
            ...
            t2 && (t2.preventDefault(), t2.stopPropagation());
          ...
          return r2.showInput(), r2.positionDropdown(), r2.refreshOptions(true), o2 && (t2 = r2.getOption(o2)).length && r2.setActiveOption(t2), true;
        }, advanceSelection: function(t2, e2) {
          var n2, i2, o2, s2 = this;
          0 !== t2 && (s2.rtl && (t2 *= -1), n2 = 0 < t2 ? "last" : "first", o2 = getInputSelection(s2.$control_input[0]), s2.isFocused && !s2.isInputHidden ? (i2 = s2.$control_input.val().length, (t2 < 0 ? 0 !== o2.start || 0 !== o2.length : o2.start !== i2) || i2 || s2.advanceCaret(t2, e2)) : (o2 = s2.$control.children(".active:" + n2)).length && (i2 = s2.$control.children(":not(input)").index(o2), s2.setActiveItem(null), s2.setCaret(0 < t2 ? i2 + 1 : i2)));
        }, advanceCaret: function(t2, e2) {
          var n2, i2 = this;
          0 !== t2 && (i2.isShiftDown ? (n2 = i2.$control_input[0 < t2 ? "next" : "prev"]()).length && (i2.hideInput(), i2.setActiveItem(n2), e2) && e2.preventDefault() : i2.setCaret(i2.caretPos + t2));
        }, setCaret: function(t2) {
          var e2 = this;
          if (t2 = "single" === e2.settings.mode ? e2.items.length : Math.max(0, Math.min(e2.items.length, t2)), !e2.isPending) for (var n2, i2 = e2.$control.children(":not(input)"), o2 = 0, s2 = i2.length; o2 < s2; o2++) n2 = $4(i2[o2]).detach(), o2 < t2 ? e2.$control_input.before(n2) : e2.$control.append(n2);
          e2.caretPos = t2;
        }, lock: function() {
          ...
          var t2 = this;
          t2.$input.prop("disabled", false), t2.$control_input.prop("disabled", false).prop("tabindex", t2.tabIndex), t2.isDisabled = false, t2.unlock();
        }, destroy: function() {
          var t2 = this, e2 = t2.eventNS, n2 = t2.revertSettings;
          t2.trigger("destroy"), t2.off(), t2.$wrapper.remove(), t2.$dropdown.remove(), t2.$input.html("").append(n2.$children).removeAttr("tabindex").removeClass("selectized").attr({ tabindex: n2.tabindex }).show(), t2.$control_input.removeData("grow"), t2.$input.removeData("selectize"), 0 == --Selectize.count && Selectize.$testInput && (Selectize.$testInput.remove(), Selectize.$testInput = void 0), $4(window).off(e2), $4(document).off(e2), $4(document.body).off(e2), delete t2.$input[0].selectize;
        }, render: function(t2, e2) {
          var n2, i2, o2 = "", s2 = false, r2 = this;
          return (s2 = "option" !== t2 && "item" !== t2 ? s2 : !!(n2 = hash_key(e2[r2.settings.valueField]))) && (isset(r2.renderCache[t2]) || (r2.renderCache[t2] = {}), r2.renderCache[t2].hasOwnProperty(n2)) ? r2.renderCache[t2][n2] : (o2 = $4(r2.settings.render[t2].apply(this, [e2, escape_html])), "option" === t2 || "option_create" === t2 ? e2[r2.settings.disabledField] || o2.attr("data-selectable", "") : "optgroup" === t2 && (i2 = e2[r2.settings.optgroupValueField] || "", o2.attr("data-group", i2), e2[r2.settings.disabledField]) && o2.attr("data-disabled", ""), "option" !== t2 && "item" !== t2 || o2.attr("data-value", n2 || ""), s2 && (r2.renderCache[t2][n2] = o2[0]), o2[0]);
        }, clearCache: function(t2) {
          void 0 === t2 ? this.renderCache = {} : delete this.renderCache[t2];
        }, canCreate: function(t2) {
          var e2;
          return !!this.settings.create && (e2 = this.settings.createFilter, t2.length) && ("function" != typeof e2 || e2.apply(this, [t2])) && ("string" != typeof e2 || new RegExp(e2).test(t2)) && (!(e2 instanceof RegExp) || e2.test(t2));
          ...
          function u2(t2, o2) {
            function e2(t3, e3) {
              t3 = $4(t3);
              var n3, i3 = hash_key(t3.val());
              (i3 || v2.allowEmptyOption) && (l2.hasOwnProperty(i3) ? e3 && ((n3 = l2[i3][O2]) ? Array.isArray(n3) ? n3.push(e3) : l2[i3][O2] = [n3, e3] : l2[i3][O2] = e3) : ((n3 = p2(t3) || {})[y2] = n3[y2] || t3.text(), n3[w2] = n3[w2] || i3, n3[C2] = n3[C2] || t3.prop("disabled"), n3[O2] = n3[O2] || e3, n3.styles = t3.attr("style") || "", n3.classes = t3.attr("class") || "", l2[i3] = n3, a2.push(n3), t3.is(":selected") && o2.items.push(i3)));
            }
            var n2, i2, s2, r2, a2 = o2.options, l2 = {}, p2 = function(t3) {
              var e3 = m2 && t3.attr(m2), t3 = t3.data(), n3 = {};
              return "string" == typeof e3 && e3.length && (isJSON(e3) ? Object.assign(n3, JSON.parse(e3)) : n3[e3] = e3), Object.assign(n3, t3), n3 || null;
            };
            for (o2.maxItems = t2.attr("multiple") ? null : 1, n2 = 0, i2 = (r2 = t2.children()).length; n2 < i2; n2++) if ("optgroup" === (s2 = r2[n2].tagName.toLowerCase())) {
              g2 = h2 = d3 = u3 = c3 = void 0;
              var c3, u3, d3, h2, g2, f2 = r2[n2];
              for ((d3 = (f2 = $4(f2)).attr("label")) && ((h2 = p2(f2) || {})[_2] = d3, h2[b2] = d3, h2[C2] = f2.prop("disabled"), o2.optgroups.push(h2)), c3 = 0, u3 = (g2 = $4("option", f2)).length; c3 < u3; c3++) e2(g2[c3], d3);
            } else "option" === s2 && e2(r2[n2]);
          }
          var d2 = $4.fn.selectize.defaults, v2 = $4.extend({}, d2, c2), m2 = v2.dataAttr, y2 = v2.labelField, w2 = v2.valueField, C2 = v2.disabledField, O2 = v2.optgroupField, _2 = v2.optgroupLabelField, b2 = v2.optgroupValueField;
          return this.each(function() {
            if (!this.selectize) {
              var t2 = $4(this), e2 = this.tagName.toLowerCase(), n2 = t2.attr("placeholder") || t2.attr("data-placeholder"), i2 = (n2 || v2.allowEmptyOption || (n2 = t2.children('option[value=""]').text()), v2.allowEmptyOption && v2.showEmptyOptionInDropdown && !t2.children('option[value=""]').length && (l2 = t2.html(), i2 = escape_html(v2.emptyOptionLabel || "--"), t2.html('<option value="">' + i2 + "</option>" + l2)), { placeholder: n2, options: [], optgroups: [], items: [] });
              if ("select" === e2) u2(t2, i2);
              else {
                var o2, s2, r2, a2, l2 = t2, p2 = i2, n2 = l2.attr(m2);
              ...
              new Selectize(t2, $4.extend(true, {}, d2, i2, c2)).settings_user = c2;
            }
          });
          ...
          this.positionDropdown = function() {
            var t2 = this.$control, e2 = "body" === this.settings.dropdownParent ? t2.offset() : t2.position(), n2 = (e2.top += t2.outerHeight(true), this.$dropdown.prop("scrollHeight") + 5), n2 = this.$control.get(0).getBoundingClientRect().top + n2 + this.$wrapper.height() > window.innerHeight ? o2.top : o2.bottom, i2 = { width: t2.outerWidth(), left: e2.left };
            n2 === o2.top ? (n2 = { bottom: e2.top, top: "unset" }, "body" === this.settings.dropdownParent && (n2.top = e2.top - this.$dropdown.outerHeight(true) - t2.outerHeight(true), n2.bottom = "unset"), Object.assign(i2, n2), this.$dropdown.addClass("selectize-position-top"), this.$control.addClass("selectize-position-top")) : (Object.assign(i2, { top: e2.top, bottom: "unset" }), this.$dropdown.removeClass("selectize-position-top"), this.$control.removeClass("selectize-position-top")), this.$dropdown.css(i2);
          };
        }), Selectize.define("auto_select_on_type", function(t2) {
          var n2, i2 = this;
          i2.onBlur = (n2 = i2.onBlur, function(t3) {
        ...
        }), Selectize.define("autofill_disable", function(t2) {
          var e2, n2 = this;
          ...
          var t2, n2 = this;
          e2 = $4.extend({ title: "Clear", className: "clear", label: "\xD7", html: function(t3) {
            return '<a class="' + t3.className + '" title="' + t3.title + '"> ' + t3.label + "</a>";
          } }, e2), n2.setup = (t2 = n2.setup, function() {
            t2.apply(n2, arguments), n2.$button_clear = $4(e2.html(e2)), "single" === n2.settings.mode && n2.$wrapper.addClass("single"), n2.$wrapper.append(n2.$button_clear), "" !== n2.getValue() && 0 !== n2.getValue().length || n2.$wrapper.find("." + e2.className).css("display", "none"), n2.on("change", function() {
              "" === n2.getValue() || 0 === n2.getValue().length ? n2.$wrapper.find("." + e2.className).css("display", "none") : n2.$wrapper.find("." + e2.className).css("display", "");
            }), n2.$wrapper.on("click", "." + e2.className, function(t3) {
              t3.preventDefault(), t3.stopImmediatePropagation(), t3.stopPropagation(), n2.isLocked || (n2.clear(), n2.$wrapper.find("." + e2.className).css("display", "none"));
            });
          });
        }), Selectize.define("drag_drop", function(t2) {
          ...
          "multi" === this.settings.mode && ((i2 = this).lock = (e2 = i2.lock, function() {
            var t3 = i2.$control.data("sortable");
            return t3 && t3.disable(), e2.apply(i2, arguments);
          }), i2.unlock = (n2 = i2.unlock, function() {
            var t3 = i2.$control.data("sortable");
            return t3 && t3.enable(), n2.apply(i2, arguments);
          }), i2.setup = (o2 = i2.setup, function() {
            o2.apply(this, arguments);
            var n3 = i2.$control.sortable({ items: "[data-value]", forcePlaceholderSize: true, disabled: i2.isLocked, start: function(t3, e3) {
              e3.placeholder.css("width", e3.helper.css("width")), n3.addClass("dragging");
            }, stop: function() {
              n3.removeClass("dragging");
              var t3 = i2.$activeItems ? i2.$activeItems.slice() : null, e3 = [];
              n3.children("[data-value]").each(function() {
                e3.push($4(this).attr("data-value"));
              }), i2.isFocused = false, i2.setValue(e3), i2.isFocused = true, i2.setActiveItem(t3), i2.positionDropdown();
            } });
          }));
        }), Selectize.define("dropdown_header", function(t2) {
          var e2, n2 = this;
          t2 = $4.extend({ title: "Untitled", headerClass: "selectize-dropdown-header", titleRowClass: "selectize-dropdown-header-title", labelClass: "selectize-dropdown-header-label", closeClass: "selectize-dropdown-header-close", html: function(t3) {
            return '<div class="' + t3.headerClass + '"><div class="' + t3.titleRowClass + '"><span class="' + t3.labelClass + '">' + t3.title + '</span><a href="javascript:void(0)" class="' + t3.closeClass + '">&#xd7;</a></div></div>';
          } }, t2), n2.setup = (e2 = n2.setup, function() {
            e2.apply(n2, arguments), n2.$dropdown_header = $4(t2.html(t2)), n2.$dropdown.prepend(n2.$dropdown_header), n2.$dropdown_header.find("." + t2.closeClass).on("click", function() {
              n2.close();
            });
          });
        }), Selectize.define("optgroup_columns", function(r2) {
          function t2() {
            var t3, e2, n2, i3, o2 = $4("[data-group]", a2.$dropdown_content), s2 = o2.length;
            if (s2 && a2.$dropdown_content.width()) {
              if (r2.equalizeHeight) {
                for (t3 = e2 = 0; t3 < s2; t3++) e2 = Math.max(e2, o2.eq(t3).height());
                o2.css({ height: e2 });
              }
          ...
          var i2, a2 = this, l2 = (r2 = $4.extend({ equalizeWidth: true, equalizeHeight: true }, r2), this.getAdjacentOption = function(t3, e2) {
            var n2 = t3.closest("[data-group]").find("[data-selectable]"), t3 = n2.index(t3) + e2;
            return 0 <= t3 && t3 < n2.length ? n2.eq(t3) : $4();
          }, this.onKeyDown = (i2 = a2.onKeyDown, function(t3) {
            var e2, n2;
            if (!this.isOpen || t3.keyCode !== KEY_LEFT && t3.keyCode !== KEY_RIGHT) return i2.apply(this, arguments);
            a2.ignoreHover = true, e2 = (n2 = this.$activeOption.closest("[data-group]")).find("[data-selectable]").index(this.$activeOption), (n2 = (n2 = (n2 = t3.keyCode === KEY_LEFT ? n2.prev("[data-group]") : n2.next("[data-group]")).find("[data-selectable]")).eq(Math.min(n2.length - 1, e2))).length && this.setActiveOption(n2);
          }), function() {
            var t3, e2 = l2.width, n2 = document;
            return void 0 === e2 && ((t3 = n2.createElement("div")).innerHTML = '<div style="width:50px;height:50px;position:absolute;left:-50px;top:-50px;overflow:auto;"><div style="width:1px;height:100px;"></div></div>', t3 = t3.firstChild, n2.body.appendChild(t3), e2 = l2.width = t3.offsetWidth - t3.clientWidth, n2.body.removeChild(t3)), e2;
          });
          (r2.equalizeHeight || r2.equalizeWidth) && (hook.after(this, "positionDropdown", t2), hook.after(this, "refreshOptions", t2));
        }), Selectize.define("remove_button", function(t2) {
          var s2, e2, n2, i2, r2;
          "single" !== this.settings.mode && (t2 = $4.extend({ label: "&#xd7;", title: "Remove", className: "remove", append: true }, t2), i2 = s2 = this, r2 = '<a href="javascript:void(0)" class="' + (e2 = t2).className + '" tabindex="-1" title="' + escape_html(e2.title) + '">' + e2.label + "</a>", s2.setup = (n2 = i2.setup, function() {
            var o2;
            e2.append && (o2 = i2.settings.render.item, i2.settings.render.item = function(t3) {
              return e3 = o2.apply(s2, arguments), n3 = r2, i3 = e3.search(/(<\/[^>]+>\s*)$/), e3.substring(0, i3) + n3 + e3.substring(i3);
              var e3, n3, i3;
            }), n2.apply(s2, arguments), s2.$control.on("click", "." + e2.className, function(t3) {
              if (t3.preventDefault(), !i2.isLocked) return t3 = $4(t3.currentTarget).parent(), i2.setActiveItem(t3), i2.deleteSelection() && i2.setCaret(i2.items.length), false;
            });
          }));
        }), Selectize.define("restore_on_backspace", function(n2) {
          var i2, t2 = this;
          n2.text = n2.text || function(t3) {
            return t3[this.settings.labelField];
          }, this.onKeyDown = (i2 = t2.onKeyDown, function(t3) {
            var e2;
            if (!(t3.keyCode === KEY_BACKSPACE && "" === this.$control_input.val() && !this.$activeItems.length && 0 <= (e2 = this.caretPos - 1) && e2 < this.items.length)) return i2.apply(this, arguments);
            e2 = this.options[this.items[e2]], this.deleteSelection(t3) && (this.setTextboxValue(n2.text.apply(this, [e2])), this.refreshOptions(true)), t3.preventDefault();
          });
        }), Selectize.define("select_on_focus", function(t2) {
          var n2, e2, i2 = this;
          i2.on("focus", (n2 = i2.onFocus, function(t3) {
          ...
          })), i2.onBlur = (e2 = i2.onBlur, function(t3) {
          ...
          o2.tagLimit = o2.tagLimit, this.onBlur = function() {
            const i2 = t2.onBlur;
            return function(t3) {
              if (i2.apply(this, t3), t3) {
                var t3 = this.$control, e2 = t3.find(".item");
                const n2 = o2.tagLimit;
                void 0 === n2 || e2.length <= n2 || (e2.toArray().forEach(function(t4, e3) {
                  e3 < n2 || $4(t4).hide();
                }), t3.append("<span><b>" + (e2.length - n2) + "</b></span>"));
              }
            };
          }(), this.onFocus = function() {
            const e2 = t2.onFocus;
            return function(t3) {
              e2.apply(this, t3), t3 && ((t3 = this.$control).find(".item").show(), t3.find("span").remove());
            };
          }();
        });
        return Selectize;
